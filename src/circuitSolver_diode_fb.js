...
(function () {
    ...
    var Component = function (id, type, value, nodes, dark_current) {
        this.id = id;
        this.type = type;
        this.value = value;
        this.nodes = nodes;
    ...
    CiSo.prototype.addComponent = function (id, type, value, nodeLabels, dark_current) {
        var component = new Component(id, type, value, nodeLabels, dark_current), // Make a new component with the right properties
				i, ii, node;
    ...
    CiSo.prototype.solve = function () {
        ...
        var check = true, i, ii, temp1 = 0, temp2 = 0, value_original, temp = false;
        while (check === true) {
            check = false;
            for (i = 0, ii = components.length; i < ii; i++) {
                ...
                if (component.type === "Diode") {
                    ...
                    if (index1 != -1 && index2 != -1) {
                        if (Math.abs(temp1 - (component.value * component.dark_current * (Math.exp(((res.elements[0][index1]).real - (res.elements[0][index2]).real) * 40) - 1))) >= 0.00001) {
                            ...
                            alert("Voltage before previous across diode is " + temp2);
                            alert("Previous voltage across diode is " + temp1);
                            ...
                            temp2 = temp1;
                            temp1 = (component.value * component.dark_current * (Math.exp(((res.elements[0][index1]).real - (res.elements[0][index2]).real) * 40) - 1));
                        ...
                        if (Math.abs(temp1 - (component.value * component.dark_current * (Math.exp((-(res.elements[0][index2]).real * 40) - 1))) >= 0.00001)) {
                            ...
                            temp2 = temp1;
                            temp1 = (component.value * component.dark_current * (Math.exp(-(res.elements[0][index2]).real * 40) - 1));
                        ...
                        if (Math.abs(temp1 - (component.value * component.dark_current * (Math.exp(((res.elements[0][index2]).real * 40) - 1))) >= 0.00001)) {
                            ...
                            temp2 = temp1;
                            temp1 = (component.value * component.dark_current * (Math.exp((res.elements[0][index1] * 40).real) - 1));
             ...
             /*       if (!check && Math.abs(temp2 - temp1) <= 0.001) {
                        if (component.value >= value_original)
                            component.value = component.value * 2;
                        else
                            component.value = component.value / 2;
                        if (component.value > 1000 * value_original)
                            component.value = value_original / 2;
