describe("CircuitSolver", function () {
    ...
    describe("Adding components", function () {
        ...
        it("We can add a fourth component", function () {
            ciso.addComponent("D1", "Diode", 2000, ["n5", "n6"], 0.00001);
            numComponents = ciso.components.length;
            ...
            fourthComponentDark_Current = ciso.components[3].dark_current;
            ...
            expect(fourthComponentDark_Current).toBe(0.00001);
        });
    ...
    describe("Solving basic DC circuits", function () {
		...
		**/
        ...
        it("We can solve a complex diode-resistor wheatstone bridge circuit", function () {
            ...
            alert(ciso.getVoltageAt("n3", 0).real)
            expect(ciso.getVoltageAt("n4", 0).real).toBeAbout(4.67);
            alert(ciso.getVoltageAt("n4", 0).real)
        });

        it("We can solve a diode-resistor series circuit", function () {
            var ciso = new CiSo();
            ciso.addComponent("R1", "Resistor", 5000, ["n1", "n2"]);
            ciso.addComponent("D1", "Diode", 5000, ["n3", "n2"], 0.00001);
            ...
            ciso = new CiSo();
            ciso.addComponent("R1", "Resistor", 5000, ["n1", "n2"]);
            ciso.addComponent("D1", "Diode", 1000, ["n2", "n3"], 0.00001);
            ciso.addVoltageSource("DCV1", 12, "n1", "n3");
            ...
            ciso = new CiSo();
            ciso.addComponent("R1", "Resistor", 5000, ["n1", "n2"]);
            ciso.addComponent("D1", "Diode", 5000, ["n2", "n3"], 0.00001);
            ciso.addVoltageSource("DCV1", 12, "n3", "n1");
